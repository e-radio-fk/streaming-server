...
function get_current_user() {
  ...
  if (!user || user.uid == undefined || user == 'no-user') user_name = 'guest';else user_name = user.displayName;
  return user_name;
} //
...
},{"@babel/runtime/helpers/interopRequireDefault":1,"socket.io-client":31}]},{},[40]);
